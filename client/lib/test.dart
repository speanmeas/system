...
class MyHomePageState extends State<MyHomePage> {
  ...
  List<Employee> getEmployeeData() {
    return [
      ...
      Employee(10003, 'Lara', 'abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ', 15000), //
  ...
  DataGridRowAdapter buildRow(DataGridRow row) {
    return DataGridRowAdapter(
      cells: row.getCells().map<Widget>((e) {
        return Container(alignment: Alignment.center, padding: EdgeInsets.all(8.0), child: Text(e.value.toString()));
      }).toList(),
    );
  }
}
